...
# Set download directory based on settings
if history_enabled:
    download_dir = os.path.join(save_path, "history")
elif update_enabled:
    download_dir = os.path.join(save_path, "loaded")
    
    # Erase all files in the "loaded" folder if update is True
...
default_filename = os.path.join(download_dir, "incidents.csv")
final_filename = os.path.join(download_dir, target_filename)
